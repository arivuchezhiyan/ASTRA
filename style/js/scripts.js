...
            }
    ...
    $cubemosaic.cubeportfolio({
        ...
        loadMoreAction: 'click',
        layoutMode: 'mosaic',
        mediaQueries: [{width: 1440, cols: 3}, {width: 1024, cols: 3}, {width: 768, cols: 3}, {width: 575, cols: 2}, {width: 320, cols: 2}],
        defaultFilter: '*',
        animationType: 'quicksand',
        gapHorizontal: 10,
        gapVertical: 10,
    ...
    $cubemosaicfull.cubeportfolio({
        ...
        loadMoreAction: 'click',
        layoutMode: 'mosaic',
        mediaQueries: [{width: 1440, cols: 2}, {width: 1024, cols: 2}, {width: 768, cols: 2}, {width: 575, cols: 2}, {width: 320, cols: 2}],
        defaultFilter: '*',
        animationType: 'quicksand',
        gapHorizontal: 0,
        gapVertical: 0,
    ...
    function enablelightGallery(){
        $('.light-gallery').each(function() {
            var $this = $(this);
            var select = 'a';
            if ($this.find('.cbp-item').length > 0) {
                select = '.cbp-item:not(.cbp-item-off):visible a';
            }
            $this.lightGallery({
                thumbnail: false,
                selector: select,
	...
	// Re-initialize lightGallery dynamically when Cube Portfolio filters are clicked or completes
	...
	$(document).on('click.cbp-filter', '.cbp-filter-item', reinitLightGallery);
	$(document).on('filterComplete.cbp', '#cube-grid-mosaic, #cube-grid, #cube-grid-full, #cube-grid-large, #cube-grid-mosaic-full', reinitLightGallery);
	/*-----------------------------------------------------------------------------------*/
    /*	COUNTER UP
    /*-----------------------------------------------------------------------------------*/
